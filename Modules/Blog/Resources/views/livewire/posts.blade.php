	...
	<div class="row mb-3">
		...
		<div class="col-md-3 col-3 text-left">
			<div class="paginationEntries">
				<label class="mb-0" for="paginate">Per page</label>
		...
		<div class="col-md-10 mb-2">
			...
			<div>
				...
				you want to Select All <strong>{{ $posts->total() }}</strong>? <a
	...
	<div class="table-responsive">
		<table class="table table-hover" width="100%" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					<th><input type="checkbox" value="{{ $post->id }}"
					...
					<td><button class="btn btn-delete"
							...
							wire:click="deleteRecord({{$post->id}})">
