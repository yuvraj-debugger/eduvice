		...
		<div class="row">
			...
			<div class="col-6">
				<label for="name">Address</label> <input type="text" name="address"
					wire:model.debounce.365ms="address" placeholder="Address"
					id="address_university"
			...
			<div class="col-6">
				<label for="name">Zipcode</label> <input type="text" name="province"
					wire:model.debounce.365ms="pincode" id="pincode_university"
			...
			<div class="col-6">
				<label for="name">Country</label> <input type="text" name="country"
					wire:model.debounce.365ms="country" placeholder="Country"
					id="country" class="form-control bg-light border-0 small"
			...
			<div class="col-12">
					...
					<div class="row">
						<div class="col-md-5">
							<div class="form-group">
								<input type="hidden" name="hide_campus_name"
									id="hide_campus_name" wire:model="campus_id.0" /> <input
				...
				<div class=" add-input">
					@php $k=0; @endphp @foreach($inputs as $key => $value) @if($k==0)
					@else
					<div class="row">
						<div class="col-md-5">
							<div class="form-group">
								<input type="hidden" name="hide_campus_name"
									id="hide_campus_name" wire:model="campus_id.{{ $value }}" /> <input
									type="text" class="form-control" placeholder="Enter Name"
					...
					@endif @php ++$k; @endphp @endforeach
				</div>
			</div>
			<div wire:ignore>
				<div class="col-12">
					<label for="name">About University</label>
					<textarea id="aboutckeditor" name="about" wire:mode="about"
						placeholder="About">{{$universityData->about}}</textarea>
			...
			<div class="col-6">
							<label>Image</label>
							<label for="img"
							class="btn btn-default uploadlabel"><i class="fa fa-upload"></i> Upload New
							Photo</label>
							<input accept="image/*"
								id="img" type="file" class="form-control" style="display: none;"
								name="image" wire:model="logo" />
							@if($logo) <img class="mb-3"
								src="{{$logo->temporaryUrl()}}" width="25" height="30"> @else
							<br /> <img class="mb-3" src="<?=$universityData->logo?>" width="50" height="80"> @endif
						
						</div>
			
			<div class="col-12 mt-2">
				<button type="submit"
					class="btn btn-primary btn-user submit_button addBtn mt-3 px-4">Save</button>
			</div>
...
<script
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDlFzDJS-mRsh7Ol928Nge6hbe9wUYuTNY&libraries=places&callback=initMap"></script>
<script>
    ClassicEditor
