        ...
        <div class="content container-fluid">
            ...
            <div class="dashboardSection">
                   <div class="dashboardSection__body commonBoxShadow rounded-1">
                     ...
                     @if((Auth::user()->user_role==0)||(Permission::userpermissions('update',1, 'profile_information')&&RolesPermission::userpermissions('update',1, 'profile_information')) ) 

                            <div class="col-xl-1 col-lg-1 col-md-1">
                                <div class="editProfile text-end">
                                    <a data-bs-toggle="modal" wire:click="edit('{{$userData->_id }}')" data-bs-target="#personalInfo" 
                                        href="javascript:void(0);"><img src="/images/editIcon.svg" /></a>
                                </div>
                            </div>
                            @endif
                ...
                <div class="dashboardSection__body commonBoxShadow rounded-1 mt-5">
                    ...
                    <ul class="nav nav-pills commonTabs" id="pills-tab" role="tablist">
                     @if((Auth::user()->user_role==0)||(Permission::userpermissions('personal_information',1)) ) 
                        ...
                        @endif
                      @if((Auth::user()->user_role==0)||(Permission::userpermissions('bank_information',1)) ) 
                        <li class="nav-item" role="presentation" wire:ignore>
                ...
                <div class="tab-content mt-5" id="pills-tabContent">
                               ...
                               @if((Auth::user()->user_role==0)||(Permission::userpermissions('personal_information', 1)|| RolesPermission::userpermissions('personal_information',1)) ) 
                                <div class="profileCard commonBoxShadow rounded-1 mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <p><b>{{@$userData['spouse_employment']}}</b></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="commonTableResponsive familyInformation">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-label="Relationship">{{$family['relationship']}}</td>
                                                    ...
                                                    <td data-label="Action">
                                                      ...
                                                      @if((Auth::user()->user_role==0)||(Permission::userpermissions('delete',2, 'family_information')|| RolesPermission::userpermissions('delete',2, 'family_information'))) 
                    ...
                    <div class="tab-pane {{$tab == 'attendance'?'show active':'fade'}}" id="pills-attendance" role="tabpanel"
                        ...
                        <div class="profileCard commonBoxShadow rounded-1 mb-3">
                            ...
                            <a class="editIcon" data-bs-toggle="modal" data-bs-target="#leavesInfo" href="javascript:void(0);">
                                <img src="/images/editIcon.svg">
                            </a>
                            @endif
                            <h3>Attendance</h3>
                    ...
                    @if((Auth::user()->user_role==0)||(Permission::userpermissions('profile_leaves',1)|| RolesPermission::userpermissions('profile_leaves',1)) ) 
                        <div class="profileCard commonBoxShadow rounded-1 mb-3">
                            ...
                            <div class="pageFilter mb-3 mt-4 p-0">
                             ...
                             @if ($check)
                            <div class="btn-group">
                                <button type="button" class="btn btn-secondary" style="background-color:red;" onclick="confirm('Are you sure you want to delete these Records?') || event.stopImmediatePropagation()"
                                                        ...
                                                        <td>
                                                            <div class="actionIcons">
                                                                <ul>
                                                                    ...
                                                                    <li><button class="bin" type="button "  onclick="confirm('Are you sure you want to delete this Records?') || event.stopImmediatePropagation()" wire:click="delete('{{$employ->id}}')"><i class="fa-regular fa-trash-can"></i></button></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
            ...
            <div class="modal-body">
                ...
                <form wire:submit.prevent="submitProfileInfo" enctype="multipart/form-data" class="px-3">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input wire:model="blood_group" type="text" class="form-control" placeholder="Enter Blood Group" />
                                @error("blood_group")
                                    <span class="error text-danger">{{$message}}</span>
                                @endError
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mt-4">
                                <button class="btn commonButton" type="submit">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select type="text"  id="document_type" wire:model="type" class="form-control">
                                        <option value=""></option>
                                    ...
                                    <div class="fileUploader">
                                     ...
                                     @if(!empty($document) && !is_string($document))
                                        @if($document->extension() == 'pdf')
                                            <p class="uploadFilename"><img src="{{ asset('/images/pdfIcon.svg')}}"> {{$document->getClientOriginalName()}}</p>
                                        @else
                                            <p data-ext="{{$document->extension()}}" class="uploadFilename"><img height="100" width="100" src="{{ asset('/images/docIcon.svg')}}"> {{$document->getClientOriginalName()}}</p>
                    ...
                    <form wire:submit.prevent="submitDocument" class="px-3" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Document Type <span class="text-red">*</span></label>
                                    <select type="text" id="document_select" wire:model="type" class="form-control">
                                        <option value=""></option>
                                        <option value="pdf">PDF</option>
                                        <option value="doc">DOC</option>
                                    </select>
                                    ...
                                    <div class="fileUploader">
                                     ...
                                     @if(!empty($document) && !is_string($document))
                                        @if($document->extension() == 'pdf')
                                            <p class="uploadFilename"><img src="{{ asset('/images/pdfIcon.svg')}}"> {{$document->getClientOriginalName()}}</p>
                                        @else
                                            <p class="uploadFilename"><img height="100" width="100" src="{{ asset('/images/docIcon.svg')}}"> {{$document->getClientOriginalName()}}</p>
                                        @endif  
                                    @else
                                        @if(!empty($document))
                                            @php $extArr = explode('.',$document); $extension = $extArr[count($extArr) - 1]; 
