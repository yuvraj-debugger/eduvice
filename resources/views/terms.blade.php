<x-guest-layout>
    <div class="pt-4 bg-gray-100">
        <div class="min-h-screen flex flex-col items-center">
            ...
            <div class="container mx-auto mt-6 mb-6 p-6 bg-white shadow-md sm:rounded-lg terms">
               
                <h1>TERMS OF USE</h1>

<p>Last updated 16 August 2023</p>


<h2>AGREEMENT TO OUR LEGAL TERMS</h2>

<p>We are Eduvice Ltd.</p>
...
<p>You can contact us by email at mailto:info@eduvice.co.uk or by mail to 5 brayford square, London, E1 0SG. United Kingdom.</p>

<p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and __________, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
...
<p>access the Services; and download or print a copy of any portion of the Content to which you have properly gained access.</p>
...
<p>These Legal Terms shall be governed by and defined following the laws of _________. _________ and yourself irrevocably consent that the courts of __________ shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
...
<p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be _________. The seat, or legal place, or arbitration shall be _________. The language of the proceedings shall be _________. The governing law of these Legal Terms shall be substantive law of _________.</p>
